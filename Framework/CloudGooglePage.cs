...
namespace Framework 
{
    public class CloudGooglePage : AbstractPage
    {
        private readonly string url = DataReader.GetUrl(DataReader.Url.cloudGooglePage);
        public CloudGooglePage(IWebDriver driver) : base(driver) { }
        public override CloudGooglePage OpenPage()
        {
